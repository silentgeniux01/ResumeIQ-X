-- ResumeIQ-X Database Setup Script
-- Run this after Railway deployment to set up the database

-- Create database (if not exists)
CREATE DATABASE IF NOT EXISTS resumeiqx CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE resumeiqx;
...
SELECT 'Email: admin@resumeiqx.ai' as email;
